label day4:
    ...
    a "\"And I did some change to our house using my little magic."\"
    "The style of this house is totally different, which is kind old-fashioned."
    a "This is the special systle, especially for today"
    "Wait... only for today? why?"
    ...
    a smile "\" Okay, let's start with my family. "\"
